...
(function ($) {
    ...
    $(".single-post .entry-info").stick_in_parent({"offset_top": 64,
    ...
    $(window).on(
        ...
        () => {
            ...
            var $mainMenu = $(".main-menu").on(
                "click",
                "span.sub-arrow",
                function (e) {

                    const obj = $mainMenu.data("smartmenus");
    ...
    $(window).on(
        ...
        () => {
            ...
            $(".blog-item-holder.has-post-thumbnail").not(".gif").
                each(function () {

                    $(this).find(".item-text").
                        css(
                            "margin-top",
                            0 - $(this).find(".item-info").
                                outerHeight()
                        );
    ...
    function multiClickFunctionStop (e) {
        ...
        $("html, body, .sidebar, .menu-left-part, .menu-right-part, .site-content").toggleClass("open").
            delay(500).
            queue(function (next) {
    ...
    function showFirstBlogPostFeatureImge () {
        ...
        $(".blog-item-holder .entry-holder").first().
    ...
    function showBlogPostFeatureImge () {
        ...
        console.log("yo");
        $(".blog-item-holder .entry-holder").on(
            "hover",
            function () {
    ...
    function fixPullquoteClass () {
        ...
        $("figure.wp-block-pullquote").find("blockquote").
            first().
